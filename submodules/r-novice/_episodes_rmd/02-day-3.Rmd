...
```{r color-by-species-1, eval = FALSE, purl=FALSE}
ggplot(data = surveys_complete, mapping = aes(x = weight, y = hindfoot_length)) +
...
>
> ```{r scatter-challenge-answer, answer=TRUE, eval = FALSE, purl=FALSE, results='markup'}
> ggplot(data = surveys_complete,
...
```{r boxplot, eval = FALSE, purl=FALSE}
...
```{r boxplot-with-points, eval = FALSE,  purl=FALSE}
ggplot(data = surveys_complete, mapping = aes(x = species_id, y = weight)) +
...
```{r first-time-series, eval = FALSE, purl = FALSE}
...
```{r time-series-by-species, eval = FALSE, purl = FALSE}
...
```{r time-series-with-colors, eval = FALSE, purl = FALSE}
...
```{r integrating-the-pipe, eval = FALSE, purl=FALSE}
yearly_counts %>%
...
```{r pipes-and-manipulation, eval = FALSE, purl=FALSE}
...
```{r first-facet, eval = FALSE, purl = FALSE}
ggplot(data = yearly_counts, aes(x = year, y = n)) +
    geom_line() +
...
```{r facet-by-genus-and-sex,eval = FALSE,  purl=FALSE}
...
```{r average-weight-time-facet-both, eval = FALSE, purl=FALSE, fig.width=9.5}
...
```{r average-weight-time-facet-sex-rows, eval = FALSE, purl=FALSE, fig.height=8.5, fig.width=8}
...
```{r average-weight-time-facet-sex-columns, eval = FALSE, purl=FALSE, fig.width=9.5, fig.height=5}
...
```{r facet-by-species-and-sex-white-bg, eval = FALSE, purl=FALSE}
 ggplot(data = yearly_sex_counts,
        mapping = aes(x = year, y = n, color = sex)) +
     geom_line() +
...
>
> ```{r average-weight-time-series, answer=TRUE, eval=FALSE, purl=FALSE, results='markup'}
...
```{r number-species-year-with-right-labels, eval = FALSE, purl = FALSE}
...
```{r number-species-year-with-right-labels-xfont-size, eval = FALSE, purl=FALSE}
ggplot(data = yearly_sex_counts, mapping = aes(x = year, y = n, color = sex)) +
    geom_line() +
    facet_wrap(vars(genus)) +
    labs(title = "Observed genera through time",
...
```{r number-species-year-with-theme, eval = FALSE, purl=FALSE}
ggplot(data = yearly_sex_counts, mapping = aes(x = year, y = n, color = sex)) +
    geom_line() +
    facet_wrap(vars(genus)) +
    labs(title = "Observed genera through time",
...
```{r number-species-year-with-right-labels-xfont-orientation, eval = FALSE, purl = FALSE}
...
```{r gridarrange-example, message = FALSE, eval = FALSE, purl = FALSE, fig.width = 10}
library(gridExtra)
