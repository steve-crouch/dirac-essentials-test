...
### Bash Shell: Writing Basic Scripts
...
There are a few prerequisites required for the workshop you'll have to set up before you can start.

#### Git & Shell

We'll be using git on the command line, so if you don't already have both git and a shell you'll need to install them:
...
We'll be using the website [GitHub](https://github.com) to host and share our work with collaborators. You'll need to [create an account there](https://github.com/signup). As your GitHub username will appear in the URLs of your projects there, it's best to use a short, clear version of your name if you can.

Please do this even if you have an institutional GitLab you plan on using for your research! 
